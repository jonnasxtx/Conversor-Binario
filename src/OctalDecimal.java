...
public class OctalDecimal extends JFrame implements ActionListener {

 JFrame frame = new JFrame("Octal > Decimal");
 JButton button;
  ...
  frame.setLayout(new FlowLayout());
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==button) {
            ...
            int n = 0;    
            int octal;
            octal = Integer.parseInt(textField.getText());
            while(octal != 0){     
                int x = octal%10;    
                decimal += x*Math.pow(8, n);    
                octal = octal/10;    
                n++;    
